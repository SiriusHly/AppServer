...
public class Test {
    ...
    private static void declareMethod() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {

        Class<?> clazz = Class.forName("com.hly.java.reflect.User");
        Object o = clazz.newInstance();
        //getMethod 可以调用父类的方法
        Method method = clazz.getMethod("printPeople");
        method.invoke(o);
    }


    /**
     * 获取当前类的所有声明的方法，包括public、protected和private修饰的方法 ,在父类中不算
     * @throws ClassNotFoundException
     * @throws IllegalAccessException
     * @throws InstantiationException
     * @throws NoSuchMethodException
     * @throws InvocationTargetException
     */
    private static void method() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {

        Class<?> clazz = Class.forName("com.hly.java.reflect.User");
        Object o = clazz.newInstance();
        //getMethod 可以调用父类的方法
        Method method = clazz.getDeclaredMethod("print");
        //获得当前类中的private 方法必须设置，不然无法使用
        method.setAccessible(true);
        method.invoke(o);
    }
